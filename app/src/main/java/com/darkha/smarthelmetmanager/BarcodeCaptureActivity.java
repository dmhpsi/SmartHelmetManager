...
//        }
    ...
    private void createCameraSource() {
        ...
        Log.e("Size", "mw " + metrics.widthPixels + " mh " + metrics.heightPixels);
    ...
    public void onObjectDetected(Barcode data) {
        ...
        String name, address;
        String scanResult = data.displayValue;

        Log.e("On detect", scanResult);

        QrParser qrParser = new QrParser(scanResult);
        name = qrParser.getName();
        address = qrParser.getAddress();

        ImageButton button = findViewById(R.id.button_toggle_connection);
        TextView textName = findViewById(R.id.text_info_name);
        TextView textAddress = findViewById(R.id.text_info_address);
        ...
        if (name != null && address != null) {
            ...
            button.setOnClickListener(v -> {
                ...
                mIntent.putExtra(Constants.BARCODE.NAME, finalName);
                mIntent.putExtra(Constants.BARCODE.ADDRESS, finalAddress);
